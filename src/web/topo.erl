...
draw_topo() ->
  ...
  WV1 = [begin
           I = maps:get(lldpChassisId, X),
           N = maps:get(lldpSysName, X),
  ...
  WE1 = [begin
           F = maps:get(from, X),
           T = maps:get(to, X),
           PortF = maps:get(lldpLocPortId, X),
           PortT = maps:get(lldpRemPortId, X),
           DescF = maps:get(lldpLocPortDesc, X),
           DescT = maps:get(lldpRemPortDesc, X),
